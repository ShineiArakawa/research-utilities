...
# This code is copied from the matplotlib library (https://github.com/matplotlib/matplotlib/blob/main/lib/matplotlib/_cm_listed.py)
# and modified to include only the color maps we need.
...
_twilight_data = [[0.88575015840754434, 0.85000924943067835,  0.8879736506427196],
...
_berlin_data = [[0.62108, 0.69018, 0.99951],
...
_managua_data = [[1, 0.81263, 0.40424],
...
_vanimo_data = [[1, 0.80346, 0.99215],
...
cmaps = {
    'magma': np.array(_magma_data, dtype=np.float64),
        'inferno': np.array(_inferno_data, dtype=np.float64),
        'plasma': np.array(_plasma_data, dtype=np.float64),
        'viridis': np.array(_viridis_data, dtype=np.float64),
        'cividis': np.array(_cividis_data, dtype=np.float64),
        'twilight': np.array(_twilight_data, dtype=np.float64),
        'twilight_shifted': np.array(_twilight_shifted_data, dtype=np.float64),
        'turbo': np.array(_turbo_data, dtype=np.float64),
        'berlin': np.array(_berlin_data, dtype=np.float64),
        'managua': np.array(_managua_data, dtype=np.float64),
        'vanimo': np.array(_vanimo_data, dtype=np.float64)
    }

np.savez_compressed('cmap_luts.npz', **cmaps, allow_pickle=False)
